...
/*
 * 19 physical columns mapping to 17 logical columns.
 * Column 13 (Deductions) spans 3 sub-columns: E.S.I, P.F, Others.
 * Widths sum to 100%.
 */
const COL = {
  sl: "3%",
    ...
    <Document>
      <Page size="A4" style={s.page} orientation="landscape">
        ...
        <View style={s.table}>
          ...
          <View style={s.hdrRow}>
            {/* Individual columns 1–7 (span full header height) */}
            ...
            {/* AMOUNT OF WAGES EARNED group (cols 8–12) */}
            ...
            {/* Deduction if any — col 13 with 3 sub-columns */}
